...
A munkaterület tárolási korlátai a Saját munkaterületen és az alkalmazás-munkaterületen is attól függnek, hogy a munkaterület [megosztott vagy prémium szintű kapacitásban](../fundamentals/service-basic-concepts.md#capacities) van.
