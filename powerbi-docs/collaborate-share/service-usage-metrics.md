...
- Csatlakozhat az adathalmazhoz a Power BI Desktopból. Az adathalmaz neve minden munkaterületen „Report Usage Metrics Model”. A részleteket a [Kapcsolat létrehozása közzétett adathalmazzal](../connect-data/desktop-report-lifecycle-datasets.md#establish-a-power-bi-service-live-connection-to-the-published-dataset) című szakaszban találja.
