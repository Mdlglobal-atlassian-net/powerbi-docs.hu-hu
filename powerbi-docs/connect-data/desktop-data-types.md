...
**Egész szám** – Egy 64 bites (nyolc bájtos), egész számot jelöl. Mivel egész számról van szó, nincsenek számjegyek a tizedeselválasztótól jobbra. Legfeljebb 19 számjegyet tartalmazhat, és pozitív vagy negatív egész számokat jelölhet -9 223 372 036 854 775 807 (-2^63+1) és 9 223 372 036 854 775 806 (2^63-2) között. A különféle numerikus adattípusok közül ez a típus jelölheti a lehető legnagyobb pontosságú számot.  Ahogy a Fixpontos tizedes tört szám típus, az Egész szám típus is hasznos lehet olyan esetekben, ahol felügyelet alatt szeretné tartani a kerekítést. 
