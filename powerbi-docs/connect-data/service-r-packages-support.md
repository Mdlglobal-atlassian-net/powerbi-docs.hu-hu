...
ms.locfileid: "83328151"
---
# <a name="create-visuals-by-using-r-packages-in-the-power-bi-service"></a>Vizualizációk létrehozása R-csomagokkal a Power BI szolgáltatásban
...
A **Power BI szolgáltatás** által támogatott R-csomagok megtalálhatók a következő bekezdés **Támogatott csomagok** listájában. Ha a listában nem szereplő R-csomaghoz szeretne támogatást igényelni, küldje el kérelmét a [Power BI Ideas](https://ideas.powerbi.com) webhelyre.
...
* Aktuális R-futtatókörnyezet: Microsoft R 3.4.4
...
|bármikor|0.3.3|https://cran.r-project.org/web/packages/anytime/index.html|
...
|kalap jel|6.0-78|https://cran.r-project.org/web/packages/caret/index.html|
...
|adathalmazok|3.4.4|NA|
|dátum|1.2-38|https://cran.r-project.org/web/packages/date/index.html|
...
|gistr|0.21.0|https://cran.r-project.org/web/packages/git2r/index.html|
...
|Mátrix|1.2-12|https://cran.r-project.org/web/packages/Matrix/index.html|
...
|quanteda|0.4-12|https://cran.r-project.org/web/packages/quantmod/index.html|
...
|robCompositions|clickstream|https://cran.r-project.org/web/packages/robCompositions/index.html|
...
* [Power BI-vizualizációk létrehozása R használatával](../create-reports/desktop-r-visuals.md)
