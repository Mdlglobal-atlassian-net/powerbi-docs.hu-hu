...
- Egy [Power BI Pro-licenc](../fundamentals/service-self-service-signup-for-power-bi.md)
- A [Power BI Desktop telepítése](../fundamentals/desktop-get-the-desktop.md) (nem kötelező)
- A [Power BI alapvető fogalmainak](../fundamentals/service-basic-concepts.md) ismerete
- Sablonalkalmazás nyilvános megosztását lehetővé tevő engedélyek (további információ: a Power BI [felügyeleti portálja, sablonalkalmazás beállításai](../admin/service-admin-portal.md#template-apps-settings)
...
1. A sablon munkaterületén válassza az **Alkalmazás létrehozása** lehetőséget.
    ...
    **Navigáció**
    ...
    Aktiválja az **Új navigációszerkesztőt**, amellyel definiálhatja az alkalmazás navigációs ablaktábláját (további információt a cikk [a navigációs felület megtervezésével](../collaborate-share/service-create-distribute-apps.md#design-the-navigation-experience) foglalkozó szakaszában találhat).
...
10. Ha készen áll az alkalmazás előléptetésére az üzem előtti állapotba a bérlőn kívüli további teszteléshez, térjen vissza a **Kiadáskezelés** panelre, és válassza az **Alkalmazás előléptetése** lehetőséget. 
    ...
    Ha ez a lehetőség nem jelenik meg, a lépjen kapcsolatba a felügyeleti portálon a Power BI rendszergazdájával, hogy adjon az Ön számára [engedélyeket sablonalkalmazások fejlesztéséhez](../admin/service-admin-portal.md#template-apps-settings).
