...
A vizualizációk a közösségtől is származhatnak, ezeket *egyéni vizualizációknak* nevezzük. Ha olyan vizualizációt tartalmazó jelentést kap, amelyet nem ismer fel, akkor valószínűleg egyéni vizualizációról van szó. Ha segítségre van az egyéni Vizualizáció értelmezése <!--[look up the name of the report or dashboard *designer*](end-user-owner.md)-->a jelentés vagy irányítópult nevére kereshet *designer* , és forduljon az őt.
