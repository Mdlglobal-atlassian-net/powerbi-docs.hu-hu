...
![zöld pont](media/end-user-license/power-bi-green-dot.png) a funkció elérhető az aktuális forgatókönyvben    
![narancssárga x](media/end-user-features/orange-x.png) a funkció nem érhető el az aktuális forgatókönyvben    
 **![zöld mw](media/end-user-features/green-mwo.png)** a funkció csak a **Saját munkaterületen** érhető el. A **Saját munkaterületen** található tartalmak a tulajdonos személyes használatára szolgálnak, és nem oszthatók meg másokkal, illetve azokat senki más nem tekintheti meg a Power BI-ban.    
 \* a funkció elérését egy Pro-felhasználó vagy rendszergazda engedélyezheti vagy kapcsolhatja ki.    
 <br><br>
...
|Megnyitás | ![narancssárga x](media/end-user-features/orange-x.png) | ![zöld pont](media/end-user-license/power-bi-green-dot.png)  | 
|Kedvenc | ![narancssárga x](media/end-user-features/orange-x.png) | ![zöld pont](media/end-user-license/power-bi-green-dot.png)  |
 |Szerkesztés, frissítés, újraosztás, ismételt közzététel |![narancssárga x](media/end-user-features/orange-x.png)  |![narancssárga x](media/end-user-features/orange-x.png)   |
 |Új alkalmazás létrehozása |![narancssárga x](media/end-user-features/orange-x.png)  |![narancssárga x](media/end-user-features/orange-x.png)   |
 |Appsource: letöltés és megnyitás | ![narancssárga x](media/end-user-features/orange-x.png)  |![narancssárga x](media/end-user-features/orange-x.png) | 
|Vállalati tároló: letöltés és megnyitás|![narancssárga x](media/end-user-features/orange-x.png)  |![zöld pont](media/end-user-license/power-bi-green-dot.png)  |
 |**Alkalmazás-munkaterületek**
| Munkaterület vagy tartalom létrehozása, szerkesztése vagy törlése  | ![narancssárga x](media/end-user-features/orange-x.png)  |![narancssárga x](media/end-user-features/orange-x.png) |
|Ajánlások hozzáadása | ![narancssárga x](media/end-user-features/orange-x.png)  |![narancssárga x](media/end-user-features/orange-x.png) | 
|Megnyitás és megtekintés  |  ![narancssárga x](media/end-user-features/orange-x.png) |  ![zöld pont](media/end-user-license/power-bi-green-dot.png)  | 
| A munkaterület adatfolyamaiban tárolt információk beolvasása |![narancssárga x](media/end-user-features/orange-x.png) |![zöld pont](media/end-user-license/power-bi-green-dot.png)|
|**Irányítópultok**
|Munkatársaktól származó irányítópultok fogadása, megtekintése és használata | ![narancssárga x](media/end-user-features/orange-x.png) |  ![zöld pont](media/end-user-license/power-bi-green-dot.png)  | 
| Riasztások hozzáadása csempékhez  |  ![zöld myw](media/end-user-features/green-mwo.png) |  ![zöld pont](media/end-user-license/power-bi-green-dot.png)  | 
| Mások megjegyzéseinek megtekintése és reagálás azokra: saját megjegyzések hozzáadása  |  ![narancssárga x](media/end-user-features/orange-x.png) |  ![zöld pont](media/end-user-license/power-bi-green-dot.png)*  | 
| Másolat mentése | ![zöld myw](media/end-user-features/green-mwo.png) |![narancssárga x](media/end-user-features/orange-x.png) | 
|A vizualizációt képként másolja? |![zöld myw](media/end-user-features/green-mwo.png) |![zöld pont](media/end-user-license/power-bi-green-dot.png)|
|Létrehozás, szerkesztés, frissítés, törlés | ![zöld myw](media/end-user-features/green-mwo.png) |![narancssárga x](media/end-user-features/orange-x.png) | 
|Csempe exportálása az Excelbe |![zöld myw](media/end-user-features/green-mwo.png) | ![zöld pont](media/end-user-license/power-bi-green-dot.png)|
|Kedvenc |![zöld myw](media/end-user-features/green-mwo.png)| ![zöld pont](media/end-user-license/power-bi-green-dot.png)|
|Funkció |![zöld myw](media/end-user-features/green-mwo.png) |![zöld pont](media/end-user-license/power-bi-green-dot.png)|
...
|  Szűrők: állandó  |![zöld myw](media/end-user-features/green-mwo.png)* |![zöld pont](media/end-user-license/power-bi-green-dot.png)* |
