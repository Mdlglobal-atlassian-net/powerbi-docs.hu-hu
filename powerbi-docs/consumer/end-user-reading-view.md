...
description: Ennek a rövid útmutatónak a segítségével a **felhasználók** megismerkedhetnek a Power BI szolgáltatás használatával.
services: powerbi
documentationcenter: ''
author: mihart
manager: kvivek
...
### <a name="view-an-app"></a>Alkalmazás megtekintése
...
1. Válassza az **Alkalmazások** ![Alkalmazások a bal oldali navigációs panelen](./media/end-user-apps/power-bi-apps-bar.png) > **Alkalmazások letöltése** lehetőséget. 
     ...
     ![Az Alkalmazások letöltése ikon](./media/end-user-reading-view/power-bi-get-app.png)
2. Az AppSource-ban, a **Saját szervezet** területen kereséssel szűkítse az eredményeket, hogy megtalálja a keresett alkalmazást.
     ...
     ![Az AppSource-ban a Saját szervezet alatt](./media/end-user-reading-view/power-bi-appsource.png)
...
![irányítópult](media/end-user-reading-view/power-bi-dashboard.png)
...
1. A felső menüsávon válassza a **Feliratkozás** lehetőséget vagy a boríték ikont ![Feliratkozás ikon](./media/end-user-subscribe/power-bi-icon-envelope.png).
...
### <a name="view-related-content"></a>Kapcsolódó tartalom megtekintése
...
![kapcsolódó tartalom](./media/end-user-reading-view/power-bi-view-related-dashboard.png)
...
### <a name="open-and-view-a-report-and-report-pages"></a>Jelentés, illetve jelentésoldalak megnyitása és megtekintése
...
1. Egy irányítópult kattintson egy csempére. Ebben a példában a „Revenue” (Árbevétel) oszlopdiagram csempéjét választottuk.
    ...
    ![irányítópult egy kijelölt csempével](./media/end-user-reading-view/power-bi-dashboard2.png)
...
2.  Ekkor megnyílik a hozzá tartozó jelentés. Látható, hogy most a „Revenue overview” (Árbevétel áttekintése) oldalon vagyunk. Ez a jelentésoldal tartalmazza azt az oszlopdiagramot, amelyet az irányítópulton választottunk ki.
    ...
    ![megnyitott jelentés az Olvasó nézetben](./media/end-user-reading-view/power-bi-report-opens.png)
...
1. A beállításhoz a felső menüsávon kattintson a **Nézet** elemre.
    ...
    ![jelentés Nézet menüje](media/end-user-reading-view/power-bi-fit.png)

2.  Válasszon az elérhető megjelenítési lehetőségek közül. Ebben a példában a **Laphoz igazítás** lehetőséget választottuk.

    ![a jelentésnézet Laphoz igazítás ikonja](media/end-user-reading-view/power-bi-report-fit.png)    

### <a name="use-the-report-filters-pane"></a>A jelentés Szűrők paneljének használata
...
1. Kattintson a **Szűrők** ikonra a jobb felső sarokban.
   ...
   ![a szűrők ikon kiválasztása](media/end-user-reading-view/filters.png)  
...
2. Tegyen aktívvá egy vizualizációt kijelöléssel. Ekkor megjelenik minden szűrő, amelyet az adott vizualizációra (Vizualizációszintű szűrők), a teljes jelentésoldalra (Lapszintű szűrők), illetve az egész jelentésre (Jelentési szint szűrői) alkalmaztak.
   ...
   ![jelentésszűrők típusai](media/end-user-reading-view/power-bi-reading-filters.png)

3. Helyezze a kurzort egy szűrő fölé, majd bontsa ki a lefelé mutató nyíl választásával.
   
   ![szűrő kibontása](media/end-user-reading-view/power-bi-expan-filter.png)

4. Módosítsa a szűrőt, majd nézze meg, hogy ez milyen hatással van a vizualizációkra.  
   
     
     ![speciális szűrés](media/end-user-reading-view/power-bi-advanced-filter.png)
...
![rámutatás a részletek megtekintéséhez](media/end-user-reading-view/amarillachart.png)
...
###  <a name="open-the-selection-pane"></a>A **Kiválasztás** panel megnyitása
...
1. A Kiválasztás panel megnyitásához kattintson a **Megtekintés > Kiválasztás panel** elemre. A **Kiválasztás panel** beállítást állítsa Be értékre.
    ...
    ![A jelentés Kiválasztás paneljének bekapcsolása](media/end-user-reading-view/power-bi-selection-pane2.png)

2. A Kiválasztás panel megnyílik a jelentésvásznon. Tegyen aktívvá egy, a listában szereplő vizualizációt kijelöléssel.

    ![jelentés Kiválasztás panelje](media/end-user-reading-view/power-bi-selection-pane-new.png)
...
![fókusz mód](media/end-user-reading-view/powerbi-focus-mode.png)

Ha ugyanezt a vizualizációt a zavaró menüsávok, a szűrők ablaktábla vagy egyéb sötét színű elemek nélkül szeretné megjeleníteni, válassza a menüsáv tetején található **Teljes képernyő** ikont ![teljes képernyő ikon](media/end-user-reading-view/power-bi-focus-icon.png) .

![teljes képernyős mód](media/end-user-reading-view/power-bi-full-screen.png)
