...
description: Megtanulhat Power BI-irányítópultot kitűzni a Windows 10 kezdőképernyőjére a Power BI mobilalkalmazásból.
author: paulinbar
ms.service: powerbi
...
![Windows-csempe](./media/mobile-pin-dashboard-start-screen-windows-10-phone-app/power-bi-windows-10-pin-start-screen.png)
...
## <a name="pin-a-dashboard-to-your-start-screen-as-a-tile"></a>Irányítópult rögzítése a kezdőképernyőn csempeként
...
2. Koppintson a **Rögzítés a kezdőképernyőn** ![Rögzítés a kezdőképernyőn ikon](./media/mobile-pin-dashboard-start-screen-windows-10-phone-app/power-bi-windows-10-pin-start-icon.png) ikonra.
   ...
   ![Windows 10-csempe](./media/mobile-pin-dashboard-start-screen-windows-10-phone-app/pbi_win10ph_startscrn.png)
