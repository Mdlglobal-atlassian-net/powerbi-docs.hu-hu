...
Az alábbi táblázat részletesebben ismerteti a funkció elérhetőségét, valamint az egyes kapacitási típusok és [tárolási mód](../connect-data/service-dataset-modes-understand.md) korlátozásait.
...
A rendszergazdák számára elérhető [Prémiummetrikák alkalmazás](../admin/service-admin-premium-monitor-capacity.md) használatával vizuálisan is megjelenítheti, hogy a kapacitás milyen hányadát használják az alacsony prioritású lekérdezések.
