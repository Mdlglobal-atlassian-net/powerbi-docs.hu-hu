...
Ha bekapcsolta a Power BI szolgáltatás **új megjelenését**![bekapcsolt új megjelenés](media/power-bi-report-filter/power-bi-new-look-on.png), az új szűrők automatikusan engedélyezve lesznek. Tájékozódjon tovább [a Power BI szolgáltatás új megjelenéséről](../consumer/service-new-look.md).
