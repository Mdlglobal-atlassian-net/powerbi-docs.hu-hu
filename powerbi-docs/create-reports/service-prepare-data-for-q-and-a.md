...
* Ha a munkafüzet PowerPivot-adatmodellt tartalmaz, akkor további optimalizálást is végezhet. Ismerkedjen meg a saját nyelvszakértőinkből álló csapat [A Power BI Q&A-val kapcsolatos mítoszok eloszlatása – 2. rész](https://powerbi.microsoft.com/blog/demystifying-power-bi-q-amp-a-part-2/) című cikkét.
...
- [Adatbeolvasás (a Power BI-ban)](../connect-data/service-get-data.md)  
