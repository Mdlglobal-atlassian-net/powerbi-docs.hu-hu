...
A DirectQuery használata során mindig figyelembe kell venni a teljesítményt, elsősorban annak érdekében, hogy a háttérbeli forrás elegendő erőforrással rendelkezzen a jó felhasználói élmény biztosításához. A jó felhasználói élmény azt jelenti, hogy a vizualizációk legfeljebb öt másodperc alatt frissülnek. További teljesítménnyel kapcsolatos tanácsokért lásd: [DirectQuery használata a Power BI-ban](desktop-directquery-about.md).
