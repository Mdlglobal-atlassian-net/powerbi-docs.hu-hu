...
* **Mértékkorlátozások:** A mértékekben használható DAX-függvények és -kifejezések köre korlátozott. Itt is igaz, hogy az automatikus kiegészítés korlátozza a felsorolt funkciók körét, és az érvénytelen függvények vagy kifejezések használata hibát eredményez. Ennek oka egyszerűen az, hogy a mértékek egyszerű mértékekké vannak korlátozva, amelyek önmagukban valószínűleg nem okoznak teljesítményproblémákat.
