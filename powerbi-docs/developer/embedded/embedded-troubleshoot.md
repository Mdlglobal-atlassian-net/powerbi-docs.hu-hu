...
### <a name="extract-error-details-from-power-bi-response"></a>Hiba részleteinek kigyűjtése a Power BI-válaszból
...
### <a name="api-call-returning-403"></a>403-as értékkel visszatérő API-hívás
