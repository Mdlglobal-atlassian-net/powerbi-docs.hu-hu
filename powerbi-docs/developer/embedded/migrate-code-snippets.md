...
## <a name="push-dataset-and-report"></a>Az adathalmaz és a jelentés leküldése

Újra össze kell állítania a jelentést a létrehozott adatkészlethez.

Ebben a kódrészletben feltételezzük, hogy a leküldhető adathalmaz már az SaaS-környezet egyik munkaterületén van. További információ a leküldési API-ról: [Adatok leküldése Power BI-adatkészletekbe](../automation/walkthrough-push-data.md).
