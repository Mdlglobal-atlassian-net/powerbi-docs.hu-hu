...
A `Legend` szolgáltatás segédinterfészt biztosít az egyéni vizualizációkhoz használható PBI-jelmagyarázatok létrehozásához és kezeléséhez.
