...
ms.locfileid: "79379329"
---
# <a name="dataviewutils"></a>DataViewUtils

A `DataViewUtils` olyan függvényeket és osztályokat tartalmaz, amelyek leegyszerűsítik a Power BI-vizualizációk DataView objektumának elemzését
