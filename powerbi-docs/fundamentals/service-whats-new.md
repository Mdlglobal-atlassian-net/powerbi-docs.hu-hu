...
* A [Power BI-alkalmazások](../collaborate-share/service-create-distribute-apps.md) egyéni navigációjának tervezési lehetősége általánosan elérhető.
...
* Teljesítménybeli fejlesztések a [Multi-Geo prémium szintű kapacitásokhoz](../admin/service-admin-premium-multi-geo.md).
* Az [olvasási/írási XMLA-végpontok](../admin/service-premium-connect-tools.md) nyilvános előzetes verziója a Power BI Prémiumban.
...
* Új [Power BI-lap](../collaborate-share/service-embed-report-microsoft-teams.md) a jelentések Microsoft Teamsbe való beágyazásához.
* A [növekményes frissítés](../admin/service-premium-incremental-refresh.md) általános elérhetősége Power BI Pro-felhasználók támogatásával.
* E-mail-előfizetések támogatása külső e-mail-címekhez.
* A Power BI Premiumhoz készült [Bring Your Own Key (BYOK)](../admin/service-encryption-byok.md) általános elérhetősége.

### <a name="january-2020"></a>2020. január
* Új és továbbfejlesztett [használati metrikák](../collaborate-share/service-usage-metrics.md) a Power BI-munkaterületek felhasználói felületén.
...
* [Nagy méretű modellek nyilvános előzetes verziója a Power BI Premiumban](../admin/service-premium-large-models.md].
...
* Az [automatizált gépi tanulás] általános elérhetősége(../transform-model/service-machine-learning-automated
* A Power BI adatéletút nézetének nyilvános előzetes verziója.

### <a name="september-2019"></a>2019. szeptember
* A [sablonalkalmazások](../connect-data/service-template-apps-overview.md) kapcsolódási konfigurációjának frissítései.
...
* A Power BI [aggregációinak](../transform-model/desktop-aggregations.md) általános elérhetősége.
...
* A [megosztott és minősített adathalmazok](../connect-data/service-datasets-across-workspaces.md) nyilvános előzetes verziója.
* A [Premium Capacity Metrics alkalmazásban](../admin/service-admin-premium-monitor-capacity.md) elérhető összes AI-metrika.
* A Power BI-[sablonalkalmazások](../connect-data/service-template-apps-overview.md) általános elérhetősége.
...
* A Power BI Premiumhoz készült Bring Your Own Key ([BYOK](../admin/service-encryption-byok.md)) nyilvános előzetes verziója.
* Megtekintői szerepkör a [munkaterületek új felületéhez](../collaborate-share/service-new-workspaces.md).

### <a name="may-2019"></a>2019. május
* [Egyéni Navigálás](../collaborate-share/service-create-distribute-apps.md) Power BI-alkalmazásokhoz.
...
* A [Power BI-adatfolyamok](../transform-model/service-dataflows-overview.md) általános elérhetősége.
...
* Elérhető a [lekérdezések gyorsítótárazása](../connect-data/power-bi-query-caching.md) a Power BI Premiumban.
...
* [Igény szerinti e-mail-feliratkozások](../collaborate-share/service-publish-to-web.md).
...
* Adatleszármaztatás [adatfolyamokhoz](../transform-model/service-dataflows-overview.md).
* Hitelesített Power BI-vizualizációk beállítása a Felügyeleti portálon.

### <a name="january-2019"></a>2019. január
* [Biztonságos Power BI-jelentések](../collaborate-share/service-embed-report-spo.md) beágyazása belső portálokba és webhelyekbe.
* Az [adatfolyamok](../transform-model/service-dataflows-overview.md) szerkesztője új összekötőkkel bővült, és mostantól támogatja a natív SQL-lekérdezéseket és a Power Query Online-transzformációkat.
...
* A Power BI adatfolyamok és az Azure Data Lake Storage Gen2 integrációjának előzetes verziója az [adatfolyamokban](../transform-model/service-dataflows-overview.md).
* A Power BI-megoldássablonok nyílt forráskódúvá váltak.

### <a name="november-2018"></a>2018. november
* A Power BI Adatok előkészítése funkciója nyilvános előzetes verzióban elérhető az [adatfolyamokban](../transform-model/service-dataflows-overview.md).
...
* Fejlesztések a Power BI [Jelentések URL-szűrőjében](../collaborate-share/service-url-filters.md).
...
* [Multi-geo támogatás](../admin/service-admin-premium-multi-geo.md) a Power BI Premiumhoz.
...
* [Témák irányítópultjai](../create-reports/service-dashboard-themes.md) a Power BI szolgáltatásban.
* [Növekményes frissítések](../admin/service-premium-incremental-refresh.md) a Prémium szolgáltatásban.
* Hozzáféréskérési munkafolyamat a [Power BI Appshez](../collaborate-share/service-create-distribute-apps.md).
* Adatfrissítések kérése, hogy a felhasználók könnyebben megtalálhassák a [Power BI alkalmazásokat](../collaborate-share/service-create-distribute-apps.md).
...
* Alapértelmezetten bekapcsolt Power BI szolgáltatásbeli [auditnaplók](../admin/service-admin-auditing.md) az Office 365-bérlőben.
...
* [Power BI-alkalmazások](../collaborate-share/service-create-distribute-apps.md) automatikus telepítése a végfelhasználók számára.
...
*    A [Power BI-alkalmazásokat](../collaborate-share/service-create-distribute-apps.md) használó tartalmak szelektív közzététele.
...
* Továbbfejlesztett töltési teljesítmény a [használati metrikákhoz](../collaborate-share/service-usage-metrics.md).
...
* A [Power BI](../connect-data/service-connect-to-services.md) online szolgáltatásokhoz készült alkalmazásainak használatbavétele.
...
* Az eredményesség felmérése és növelése az [irányítópult- és jelentéskészítőknek szánt használati metrikákkal](../collaborate-share/service-usage-metrics.md).
...
* [Power BI Q&A-támogatás az SQL Server 2016 Analysis Services rendszerbeli táblázatos modellekhez](../create-reports/service-q-and-a-direct-query.md): Örömmel jelenthetjük, hogy továbbfejlesztettük a Power BI Q&A felhasználói élményét, és megjelentettük a Power BI Q&A nyilvános előzetes verzióját a vállalati átjáró által csatlakoztatott adatforrásokhoz – elsőként pedig az SQL Server 2016 Analysis Services rendszerbeli táblázatos modellek kapnak támogatást. A részletekről [ebben a blogbejegyzésben](https://powerbi.microsoft.com/blog/power-bi-q-a-for-enterprise-gateway-connected-data-sources-now-available-in-public-preview/) olvashat.
* [Helyi fájlok támogatása az Excel-jelentésekben](../connect-data/service-excel-workbook-files.md#local-excel-workbooks): Mostantól az Excel-fájljait a helyi meghajtóról vagy más társzolgáltatásokból is feltöltheti, és az Excel-jelentést ugyanúgy használhatja a Power BI funkcióival, mint ahogyan az Excel Online-ban tenné. A részletekről [ebben a blogbejegyzésben](https://powerbi.microsoft.com/blog/powerbi-upload-excel-reports-from-local-files/) olvashat.
...
* [Tartalomcsomagok támogatása az RLS-ben](../admin/service-admin-rls.md) (előzetes verzió): Ha az RLS-t egy tartalomcsomag részeként terjesztett irányítópultokhoz és jelentésekhez definiálta, a biztonsági szabályok ezen tartalomcsomagokra is vonatkoznak.

***Irányítópultok***

* [Vimeo videócsempe](../create-reports/service-dashboard-add-widget.md):  Az irányítópultról hozzáadhat egy csempét, amely egy beágyazott Vimeo-lejátszót tartalmaz.

***Elemzés az Excelben***

* Az [Elemzés az Excelben](../collaborate-share/service-analyze-in-excel.md) funkció elérhető minden felhasználó számára: A Power BI-adatmodellek Excelben való elérését kiterjesztettünk minden felhasználóra, a hozzájuk rendelt licencektől függetlenül.
...
A Power BI csapata az ünnepek alatt sem pihent. A részletekről a [Power BI-csapat blogján](https://powerbi.microsoft.com/blog/power-bi-service-update-0106/) olvashat.
...
A részletekről a [Power BI-csapat blogján](https://powerbi.microsoft.com/blog/power-bi-service-update-0106/) olvashat.

## <a name="2015"></a>2015
**2015. December 16.**

Ezen a héten sok frissítést vezettünk be, amelyek legtöbbje a Power BI Desktopra vonatkozik, azonban néhány jelentős frissítés érkezett a jelentések készítéséhez és a vizualizációkhoz is. A [Power BI csapat blogján](https://powerbi.microsoft.com/blog/more-power-bi-feature-updates-power-bi-desktop-december-update-and-new-power-bi-service-features/) megtalálhatja ezek részletes leírását, valamint egy ismertető videót.   
...
Részletes információkat, többek között egy, a frissítéseket ismertető videót a [Power BI blogján](https://powerbi.microsoft.com/blog/more-power-bi-feature-updates-power-bi-desktop-december-update-and-new-power-bi-service-features/) találhat.
...
* Jelentésvizualizációk közti interakciók módosítása
  ...
  A részletekért látogasson el a [Power BI blogjára](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1210/).

**2015. december 8.**

* [QR-kódok a Power BI-ban](https://powerbi.microsoft.com/blog/bridge-the-gap-between-your-physical-world-and-your-bi-using-qr-codes/)

**2015. december 3.**

* Adathalmazok trendjeinek és mintáinak automatikus feltárása gyors megállapításokkal: [videó](https://powerbi.microsoft.com/blog/power-bi-updates-from-browser-to-desktop-and-new-automated-insights-mf/) vagy [cikk](../consumer/end-user-insights.md)
* [VMob-adatok megjelenítése a Power BI-ban](https://powerbi.microsoft.com/blog/visualize-your-vmob-data-in-power-bi/)
* [A Vállalati Power BI Gateway előzetes verziója](https://powerbi.microsoft.com/blog/announcing-preview-of-power-bi-gateway-for-enterprise-deployments/)
* Új tartalomcsomag: [A Bing keresési elemzései a Power BI-irányítópultokon](https://powerbi.microsoft.com/blog/search-analytics-from-bing-on-your-power-bi-dashboards/)
* Új fejlesztőközpontú fejlesztések: [Két új API és könnyebb alkalmazásregisztráció](https://powerbi.microsoft.com/blog/power-bi-for-developers-reports-api-and-a-simple-app-registration-experience)
...
A részletekért látogasson el a [Power BI blogjára](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1124/).
...
A részletekért látogasson el a [Power BI blogjára](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1117/).
...
A részletekért látogasson el a [Power BI blogjára](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1110/).
...
A részletekért látogasson el a [Power BI blogjára](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1103/).
...
A részletekért látogasson el a [Power BI blogjára](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1027/).
...
A részletekről a [Power BI blogján](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1020/) olvashat.
...
További információt a [blogunkban](https://powerbi.microsoft.com/blog/power-bi-service-weekly-update-10-06/) és az [online dokumentációban](service-get-started.md) találhat.
...
* Az Azure Mobile Engagement egy olyan alkalmazáselemzési szolgáltatás, amellyel a fejlesztők nyomon követhetik az alkalmazásaik teljesítményét, így elősegíthetik a magasabb szintű adatmegőrzést és alkalmazáshasználatot. A [Power BI Azure Mobile Engagement tartalomcsomaggal](https://powerbi.microsoft.com/blog/monitor-and-analyze-your-azure-mobile-engagement-data-in-power-bi/) egyszerűen csatlakozhat egy használatra kész irányítópulthoz, egy jelentéskészlethez és egy összeválogatott adatkészlethez, és azonnal elemezheti az alkalmazás teljesítményét. További információt a [Power BI Azure Mobile Engagement tartalomcsomag súgóoldalán](../connect-data/service-connect-to-services.md) találhat.

**2015. augusztus 11.**

* A Mandrill egy e-mail-infrastruktúrával foglalkozó szolgáltatás, amelyet a MailChimp fejlesztett. Segítségével jelentős mennyiségű információt kaphat az e-mail-kampányairól. A [Power BI Mandrill tartalomcsomaggal](https://powerbi.microsoft.com/blog/explore-and-analyze-your-mandrill-data-in-power-bi/) gyorsan csatlakozhat a Mandrill-adatokhoz, és azonnal elemezheti a hírlevél- vagy marketingkampányát. További részleteket az első lépésekről a [Power BI Mandrill tartalomcsomag súgóoldalán](../connect-data/service-connect-to-services.md) találhat.

**2015. augusztus 4.**

* A Power BI szolgáltatással a [Circuit ID](https://powerbi.microsoft.com/blog/circuit-id-data-with-power-bi/) felhasználói mostantól követhetik és megfigyelhetik a Circuit ID-n belüli felhőkommunikációs szolgáltatásaikat, így felelősebb üzleti döntéseket hozhatnak. További részleteket az első lépésekről a [Power BI Circuid ID tartalomcsomag súgóoldalán](../connect-data/service-connect-to-services.md) találhat.
* Ma kiadtunk egy fejlesztést, amellyel még könnyebbé tettük az Irányítópult megosztása funkció használatát.  Ha a cége Office 365-öt használ az e-mailek kezelésére, mostantól [megoszthat adatokat egy e-mail-terjesztési csoportban](https://powerbi.microsoft.com/blog/easier-dashboard-sharing-with-distribution-groups/), ugyanúgy, ahogyan az Outlookból e-maileket küldene.  Csak írja be a terjesztési csoport címét, és kattintson a Megosztás lehetőségre.  A terjesztési csoport minden tagja kap egy meghívót az irányítópult megtekintésére.

**2015. július 28.**

* Örömmel jelentjük, hogy a Power BI e heti frissítésében az [SQL Sentry tartalomcsomaggal](https://powerbi.microsoft.com/blog/monitoring-your-sql-sentry-data-with-power-bi/) megérkezett az adatbázis-követés funkció. A tartalomcsomag egy irányítópultot és jelentéseket tartalmaz, amelyekkel megfigyelheti a követett SQL Server-telepítéseket az SQL Sentry Cloudban. További részleteket az első lépésekről a [Power BI SQL Sentry tartalomcsomag súgóoldalán](../connect-data/service-connect-to-services.md) találhat.
...
* [A Power BI-csoportok](../collaborate-share/service-create-distribute-apps.md): a csoportokkal egy Office 365-csoportokra épülő, hatékony együttműködési platformot vehet igénybe.
* [Céges tartalomcsomagok:](../collaborate-share/service-organizational-content-pack-introduction.md): A Power BI szolgáltatással rendkívül egyszerűen hozhat létre irányítópultokat és jelentéseket, a felhasználók pedig mostantól közzétehetik ezeket a tartalmakat a céges tartalomgyűjteményben.
* [Teljes Excel-fájlok importálása](../connect-data/service-excel-workbook-files.md): Bármilyen, a OneDrive Vállalati verzión tárolt Excel-munkafüzetet importálhat a Power BI-ba, és ugyanúgy megtekintheti, mintha az Excel Online-ban tenné.
* [CSV-fájlok](../connect-data/service-get-data-from-files.md) importálása: Az Excel- vagy Power BI Desktop-fájlokhoz hasonlóan CSV-fájlokat is alkalmazhat adatkészletként a Power BI irányítópultjaihoz és jelentéseihez.
...
* Örömmel jelentjük, hogy a Power BI e heti frissítésében a [Visual Studio Online tartalomcsomaggal](https://powerbi.microsoft.com/blog/monitoring-your-visual-studio-online-work-items-with-power-bi/) megérkezett az munkaelem-követés funkció. A frissítés egy új irányítópultot, egy jelentést és egy frissített adatkészletet tartalmaz, amelyekkel elemezheti a munkaelemeket. Emellett a Git-tárházzal kapcsolatos fontos metrikákat, lekéréses kérelmeket és a kezdeti verzióhoz tartozó verziókövetési tartalmakat is magában foglal. További részleteket az első lépésekről a [Power Visual Studio Online tartalomcsomag súgóoldalán](../connect-data/service-connect-to-quickbooks-online.md) találhat.

**2015. július 14.**

* Az Acumatica Cloud ERP teljes mértékben integrált, egy robusztus és rugalmas platformon futó üzleti felügyeleti alkalmazásokat kínál, például Pénzügyek, Terjesztés, CRM és Projektkönyvelés. A Power BI-hoz készült [Acumatica tartalomcsomaggal](https://powerbi.microsoft.com/blog/analyze-and-explore-your-acumatica-cloud-erp-data-with-power-bi/) gyorsan csatlakozhat a lehetőségadatokhoz, és azonnali elemzéseket kaphat róluk. Ez a tartalom egy használatra kész irányítópultot, egy jelentéskészletet és egy összeválogatott adatkészletet tartalmaz, amelyekkel elemezheti az adatokat, és olyan részleteket tárhat fel, mint például a dátum szerint rendezett elnyert lehetőségek összesítése. További tudnivalók [itt](../connect-data/service-connect-to-services.md). 
* Az [Azure HDInsight](https://powerbi.microsoft.com/blog/visualize-big-data-with-power-bi-and-spark-for-azure-hdinsight/) mostantól egy teljes körűen felügyelt Spark szolgáltatást kínál. Ez a funkció olyan forgatókönyveket tesz lehetővé, mint például az iteratív gépi tanulás vagy az interaktív adatelemzés. A Power BI szolgáltatással közvetlenül csatlakozhat a HDInsight-on keresztül a Spark-adataihoz, így egyszerűen és valós időben tárhatja fel azokat. További információt a [súgódokumentumban](../connect-data/power-bi-data-sources.md) találhat.
* [Az Office 365 navigációs és alkalmazásindítós integrációja](https://powerbi.microsoft.com/blog/new-capabilities-added-to-power-bi#launcher). Mostantól egyetlen kattintással elérheti bármelyik Office 365-alkalmazását.
* [Egyéni URL-cím megadása](https://powerbi.microsoft.com/blog/new-capabilities-added-to-power-bi#url), amelyre a felhasználók ugranak, ha egy csempére kattintanak. Mostantól pontosan megszabhatja, hova kerüljenek a felhasználók: egy adott jelentésre, egy másik irányítópultra, egy SSRS-jelentésre vagy egy külső webhelyre. 
* A Power BI-ban használt tár [láthatósága és kezelése](https://powerbi.microsoft.com/blog/new-capabilities-added-to-power-bi#storage)
* [A Q&A vizualizációinak és mezőinek konfigurálása](https://powerbi.microsoft.com/blog/new-capabilities-added-to-power-bi#visual)

**2015. július 7.**

* Mostantól elérhető a Power BI egyik legjobban várt és legtöbb felhasználó által kért funkciója. A mai naptól kezdve [frissíthetők azok adatkészletek](https://powerbi.microsoft.com/blog/refresh-for-on-premises-sources-is-here/), amelyek a helyszíni forrásokhoz, például az SQL Serverhez kapcsolódnak. A Power BI Designer-fájlokból és a Power Queryvel vagy a Power Pivottal egy Excel-munkafüzetbe importált fájlokból létrehozott adatkészletek frissíthetők. 

**2015. június 30.**

* Megjelent egy új [Power BI UserVoice tartalomcsomag](https://powerbi.microsoft.com/blog/monitor-and-visualize-your-uservoice-data-with-power-bi/), amellyel figyelheti és vizualizációkkal megjelenítheti a UserVoice-adatait, majd azonnal elemezheti őket egy használatra kész irányítópulttal és jelentéssel.

**2015. június 23.**

* A Power BI Desktop-fájlok [frissíthetők](https://powerbi.microsoft.com/blog/announcing-refresh-support-for-power-bi-designer-files-in-the-power-bi-service/) (ütemezett frissítés és azonnali frissítés) a Power BI-ba való feltöltés után.
* Megjelent a Power BI legnagyobb vizuális módosítása december óta: az [Adatok lekérése](https://powerbi.microsoft.com/blog/the-new-get-data-experience/) funkció mostantól letisztultabb és egyszerűbb.  Az Adatok lekérése gombra kattintva mostantól egyetlen képernyő jelenik meg, ahol választhat a kategóriák közül. Így még könnyebben keresheti meg a fontos tartalmakat.
* [Az SQL Data Warehouse](https://powerbi.microsoft.com/blog/exploring-azure-sql-data-warehouse-with-power-bi/) rugalmasan méretezhető, jelentős párhuzamos feldolgozást kínál. A ma bejelentett korlátozott nyilvános előzetes verzióval a Power BI-felhasználók közvetlenül csatlakozhatnak az Azure SQL Data Warehouse-ban tárolt adatokhoz, amelyeket egyszerűen és dinamikusan tárhatnak fel. Az adatraktárhoz való csatlakozás után valós időben létrejönnek a lekérdezések, amelyek az adatfeltárás során visszakerülnek a forráshoz. Ennek köszönhetően nem kell létrehoznia és feltöltenie egyéni adatmodelleket, és interaktívan vizsgálhatja az adatait.

**2015. június 16.**

* A SweetIQ-val könnyen követheti a helyi listáit – ehhez a helyi keresési rendszer helyére és értékeléseire vonatkozó adatokat kell megadnia. A Power BI szolgáltatással elemezheti és megfigyelheti ezeket az adatokat a SweetIQ-adatokból létrehozott [használatra kész tartalommal](https://powerbi.microsoft.com/blog/analyze-and-monitor-your-sweetiq-data-with-power-bi/). További részleteket az első lépésekről a Power BI SweetIQ tartalomcsomag [súgóoldalán](../connect-data/service-connect-to-services.md) találhat.

**2015. június 2.**

* A Power BI és az [appFigures-tartalomcsomag](https://powerbi.microsoft.com/blog/explore-and-analyze-your-appfigures-data-with-power-bi/) segítségével egyszerűen nyomon követheti az alkalmazásait leíró fontos statisztikákat. További részleteket a csatlakozásról és az első lépésekről a Power BI appFigures tartalomcsomag [dokumentációjában](../connect-data/service-connect-to-services.md) találhat.

**2015. május 28.**

* Ezzel a [tartalomcsomaggal](https://powerbi.microsoft.com/blog/get-quick-insights-into-your-quickbooks-online-account-data) gyors elemzéseket kaphat a QuickBooks Online fiókadatairól. További részleteket a csatlakozásról és az első lépésekről a Power BI QuickBooks Online tartalomcsomag [dokumentációjában](../connect-data/service-connect-to-quickbooks-online.md) találhat.

**2015. május 13.**

* Közvetlenül csatlakozhat az **Azure SQL Database-ben** tárolt adataihoz. A lekérdezéseket dinamikusan hozzuk létre és küldjük el a forrásnak, így Ön interaktív jelentéseket hozhat létre közvetlenül az adatbázisban. További információt ebben a [blogbejegyzésben](https://powerbi.microsoft.com/blog/using-power-bi-to-visualize-and-explore-azure-sql-databases/) és a [dokumentációban](../connect-data/service-azure-sql-database-with-direct-connect.md) találhat.
...
* A Power BI mostantól **44 nyelven** elérhető. A teljes listát ebben a [blogbejegyzésben](https://powerbi.microsoft.com/blog/power-bi-preview-now-available-in-your-language/) találhatja.

**2015. április 23.**

* Mostantól az új tartalomcsomagunkkal megjelenítheti és feltárhatja a **Microsoft Dynamics Marketing-adatait**. További információt [blogbejegyzésünkben](https://powerbi.microsoft.com/blog/monitor-and-explore-your-microsoft-dynamics-marketing-data-with-power-bi/) találhat.

**2015. április 15.**

* Mostantól az új tartalomcsomagunkkal megjelenítheti és feltárhatja a **Google Analytics-adatait**. A Google Analytics tartalomcsomag egy irányítópultot, egy jelentést és egy adatkészletet tartalmaz, amelyekkel az utóbbi 6 hónap webhelyhasználati adatait elemezheti. Olvassa el a [blogbejegyzésünket](https://powerbi.microsoft.com/blog/visualize-and-explore-your-google-analytics-data-with-power-bi/).
