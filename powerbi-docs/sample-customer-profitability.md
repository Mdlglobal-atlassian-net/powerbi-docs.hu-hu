...
Ez a minta egy olyan sorozat részét képezi, amely bemutatja, hogyan használhatja a Power BI-t üzleti adatokkal, jelentésekkel és irányítópultokkal. Az ehhez a mintához használt adatok az obviEnce-től ([www.obvience.com](http://www.obvience.com/)) származó valós, de anonimizált adatok. Többféle formátumban is elérhetőek: tartalomcsomagként vagy alkalmazásként, Excel-munkafüzetként és .pbix kiterjesztésű Power BI Desktop-fájlként is. [Power BI-minták](sample-datasets.md) megtekintése.
...
Az [Ügyfél-jövedelmezőségi mintát](http://download.microsoft.com/download/6/A/9/6A93FD6E-CBA5-40BD-B42E-4DCAE8CDD059/Customer%20Profitability%20Sample%20PBIX.pbix) .pbix-fájlként is letöltheti, amelyet a Power BI Desktoppal való használatra terveztek.
...
Nézzük meg két csapattag teljesítményét részletesen, és lássuk, mely adatokba kaphatunk betekintést. A bal oldali **Vezetők** mezőben Andrew nevének kiválasztásával szűrheti a jelentésoldalt, így csak Andrew adatai jelennek meg.
...
Most térjünk át Valeryre. A **Vezetők** mezőben Valery nevének kiválasztásával szűrheti a jelentésoldalt, így csak Valery adatai jelennek meg. 
...
* A másik **Bevétel régiónként** négyszöget kiválasztva érdekes jelenséget láthatunk: a százalékos bruttó értéke 23% és 79% között mozog. Bevételi mutatói az északi régiót kivéve minden régióban rendkívül szezonálisak.

A feltárás folytatásával kideríthető, hogy Valery régiója miért is nem teljesít jól. Nézze meg a régiókat, a többi üzleti egységet, valamint a jelentés következő lapját: **Iparági árrés elemzése**.
...
Hogyan változik a jövedelmezőség az iparágban? Hogyan oszlanak meg a termékek és az ügyfelek iparági bontásban? Ezeknek a kérdéseknek a megválaszolásához válasszon ki egy vagy több iparágat a bal felső sarokban (a fogyasztási cikkek iparágától kezdje). A szűrő törléséhez használja a radír ikont.

A buborékdiagramon (**Százalékos, költségvetéshez viszonyított bevételvariancia, Bruttó árrés % és Éves bevétel iparág szerint**) a pénzügyi vezető a legnagyobb buborékokat keresi, mert azok jelentik a bevételre a legnagyobb hatást. Ha a területi diagramon a vezetők nevére kattintva szűri a lapot, egyszerűen tekintheti meg az egyes vezetők teljesítményét iparági szegmens szerint.
...
1. Nyissa meg a jelentést szerkesztési nézetben a **Jelentés szerkesztése** lehetőséget választva. A szerkesztési nézet csak a jelentés tulajdonosa számára érhető el. Ezt a nézetet néha **létrehozói** nézetnek is hívjuk. Ha azonban a jelentést csak megosztották Önnel, akkor nem nyithatja meg Szerkesztési nézetben.
...
3. Írja be a következőt: *Valery Ushakov teljes bevétele iparág szerint*. Figyelje meg, ahogy a vizualizáció frissül, miközben beírja a kérdést.
...
Ebben a környezetben nyugodtan kísérletezhet. Bármikor dönthet úgy, hogy nem menti a változtatásokat. De ha mégis mentené őket, bármikor lekérheti a minta egy új másolatát az **Adatok lekérése** lehetőség választásával.
...
[Power BI-minták](sample-datasets.md)  
