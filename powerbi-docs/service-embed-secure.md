...
* A többoldalas jelentések biztonságos beágyazási forgatókönyvek esetén használhatóak, és az URL-paraméterekkel rendelkező többoldalas jelentések is támogatottak. További információ: [Jelentésparaméter átadása URL-címben többoldalas jelentéshez](report-builder-url-pass-parameters.md).
