...
|![Mérték](media/service-the-report-editor-take-a-tour/power-bi-field-list-measure.png) |  Mérték: A mértékek saját nem módosítható képlettel vannak kiszámítva. A számítás módja nem módosítható, egy összeg például csak összeg lehet. Az értékek nincsenek oszlopban tárolva. Menet közben vannak kiszámítva, egyedül a vizualizáción belüli helyük alapján. További információ: [A mértékek ismertetése](desktop-measures.md). |
