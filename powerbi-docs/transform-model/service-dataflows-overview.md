...
Az adatfolyamok számítási feladatainak prémium szintű kapacitásban történő engedélyezéséről lásd a [Számítási feladatok konfigurálása prémium szintű kapacitásban](../admin/service-admin-premium-workloads.md) cikket. Adatfolyam számítási feladatok több földrajzi helyes kapacitásokban jelenleg nem érhetők el.
...
* [Adatfolyamok és az Azure Data Lake integrációja](service-dataflows-azure-data-lake-integration.md)
